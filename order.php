        ...
        function validateform()
{
                        ...
                        <?php
                            ...
                            while($order_row = mysqli_fetch_assoc($order)){
                                ...
                                if ($stall_name != $prev_stall_name) {
                                    ...
                                    echo "<thead><tr><th>Order ID</th><th>Name</th><th>Price</th><th>Quantity</th><th>Amount(RM)</th></tr></thead>";
                                    echo "<tbody>";
   ...
   ?>
        ...
        <h1 class="total"><?php echo"Total: RM $totalAmount"?></h1>
        ...
        ?>
                ...
                <select name="payment_type">
                    ...
                    <option value="online">Online (additional RM1)</option>
                </select>
                </div>
    ...
    function calculateAmount(quantity, price, orderId) {
        ...
        document.querySelector('.total').innerHTML = "Total: RM " + totalAmount;
