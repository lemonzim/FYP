...
<body>
    ...
    $reason_table = mysqli_query($conn, "SELECT * from reason where target IN ('student', 'both')");
    ...
    <div class='flex'>
        ...
        <div class="mb-3">
            ...
            <input aria-describedby="emailHelp" class="form-control" readonly type="text" name="complainer" value="<?php echo "{$stall_info_row[1]}"; ?>">
            <input type="hidden" name="complainer_id" value="<?php echo "{$stall_info_row[0]}"; ?>">
        </div>

        <div class="mb-3">
            <label for="student id" class="form-label">Student ID</label>
            <input aria-describedby="emailHelp" class="form-control" readonly type="text" name="complaint_to" value="<?php echo $order_row['student_id']; ?>">
        </div>
        ...
        <button type="button"  class="button btn btn-dark"><a href="history_stall.php">Back</a></button>
    </div>
    </form>
    </div>
</body>
